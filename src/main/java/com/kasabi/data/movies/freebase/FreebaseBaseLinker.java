...
public abstract class FreebaseBaseLinker extends BaseLinker implements Linker {

	private static final Logger log = LoggerFactory.getLogger(FreebaseBaseLinker.class);
	
	private final FileManager fm;
	protected final Freebase freebase;
	
	public FreebaseBaseLinker(String base) {
		super(base);
