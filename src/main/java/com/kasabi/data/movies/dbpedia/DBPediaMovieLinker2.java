...
public class DBPediaMovieLinker2 extends DBPediaBaseLinker2 {

	private static final Logger log = LoggerFactory.getLogger(DBPediaMovieLinker2.class) ;
	
	public DBPediaMovieLinker2(String base) {
		super(base);
	}
	...
	public Pair<Resource, Model> link(String name, Resource subject, Property property) {
		...
		Pair<String,Model> pair = get(httpclient, "film", name);
