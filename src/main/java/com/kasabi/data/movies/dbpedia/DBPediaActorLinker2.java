...
public class DBPediaActorLinker2 extends DBPediaBaseLinker2 {

	private static final Logger log = LoggerFactory.getLogger(DBPediaActorLinker2.class) ;
	
	public DBPediaActorLinker2(String base) {
		super(base);
	}
