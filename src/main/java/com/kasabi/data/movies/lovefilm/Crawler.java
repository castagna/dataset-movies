...
public class Crawler {
	...
	public Crawler (String base, String startingPage, String selectItem, String selectItemURI, String selectNextPage, OutputStream out) {
		...
		while ( ( page != null ) && ( !page.equals(previousPage) ) ) {
			...
			if ( doc != null ) {
				...
				for (Element element : elements) {
					...
					pages.add(href);
					MovieScraper scraper = new MovieScraper(base, element);
					Model model = scraper.getModel();
